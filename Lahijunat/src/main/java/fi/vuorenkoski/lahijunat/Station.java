...
public class Station {
    ...
    private static List<String> names=Arrays.asList("Aviapolis","Espoo","Helsinki","Hiekkaharju","Huopalahti","Ilmala"
    ...
    private static List<Integer> codes=Arrays.asList(1331,66,1,556,72,9,578,658,65,67,621,580,63,1330,675,977,1333,1332
            ,68,661,17,659,662,64,660,693,15,10,69,657,553,551,552,18,830,579,847,839,1337,20,100,40,576,160);
    
    private static List<String> shortNames=Arrays.asList("AVP","EPO","HKI","HKH","HPL","ILA","JRS","KAN","KLH","KNI"
    ...
    /**
     * Metodi palauttaa juna-aseman koko nimen kun sille annetaan parametrina UIC koodi.
     * Mikäli asemaa ei löydy listalta, palautetaan "undefined".
     */
    ...
    /**
     * Metodi palauttaa juna-aseman lyhytnimen kun sille annetaan parametrina UIC koodi.
     * mikäli asemaa ei löydy listalta, palautetaan "---"
     */
    ...
    /**
     * Metodi palauttaa juna-aseman UIC koodin  kun sille annetaan parametrina koko nimi.
     * mikäli asemaa ei löydy listalta, palautetaan -1.
     */
